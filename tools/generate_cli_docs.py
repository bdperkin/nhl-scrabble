...
>
> This file is automatically generated from the Click CLI using `tools/generate_cli_docs.py`.
> **DO NOT EDIT MANUALLY** - Changes will be overwritten.
>
> To update: `make docs-cli` or `python tools/generate_cli_docs.py`
...
*Generated by `tools/generate_cli_docs.py` - Do not edit manually*
"""
