...
async def position_type_page(request: Request, position_type: str) -> HTMLResponse:
...
async def position_detail_page(request: Request, position_code: str) -> HTMLResponse:
