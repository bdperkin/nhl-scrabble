...
NHL Scrabble includes comprehensive internationalization support with 12 locales covering major hockey markets worldwide. Currently, 2 locales are fully translated (fr_CA, sv_SE), with others available for community contribution.

## Supported Locales

The application supports the following locales. Note that only **fr_CA** and **sv_SE** are currently fully translated. Other locales are available for community contribution:

| Region             | Locales                                     | Description                                                                  | Status            |
| ------------------ | ------------------------------------------- | ---------------------------------------------------------------------------- | ----------------- |
| **North America**  | `en_US`, `en_CA`, `fr_CA`                   | English (US), English (Canada), French (Canada)                              | fr_CA: Complete   |
| **Nordic**         | `sv_SE`, `fi_FI`                            | Swedish, Finnish                                                             | sv_SE: Complete   |
| **Central Europe** | `cs_CZ`, `de_DE`, `de_CH`, `it_CH`, `sk_SK` | Czech, German (Germany), German (Switzerland), Italian (Switzerland), Slovak | Partial/Available |
| **Eastern Europe** | `ru_RU`, `lv_LV`                            | Russian, Latvian                                                             | Partial/Available |
...
Currently, 2 of 12 locales are fully translated:

- **fr_CA** (French - Canada): 100% complete
- **sv_SE** (Swedish): 100% complete
- **Other locales**: Partial translations, community contributions welcome

See the [Contributing Translations](#for-translators) section to help complete additional locales.
