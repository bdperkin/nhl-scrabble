...
- [ ] All 254 strings translated to Slovak
- [ ] Natural, idiomatic Slovak language used
- [ ] Slovakia hockey terminology used correctly
...
- [ ] Tested in CLI: `NHL_SCRABBLE_LANG=sk_SK nhl-scrabble analyze`
