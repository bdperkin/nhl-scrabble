...
The project uses comprehensive pre-commit hooks (53 total) for automatic code quality checks:
...
- **Pre-commit Hooks**: 53 hooks (meta, pre-commit-hooks, pygrep-hooks, isort, interrogate, deptry, unimport, pydocstyle, vulture, absolufy-imports, validate-pyproject, pyroma, tox-ini-fmt, yamllint, codespell, pymarkdown, mdformat, doc8, rstcheck, uv, flake8, autoflake, black, docformatter, autopep8, ruff, mypy)
